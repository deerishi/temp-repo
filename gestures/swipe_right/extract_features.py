...
def extract_features():
	...
	line=f.readline().split('\n')[0]
	fz=open(line,'r')
	vector_file=open(r'train_swipe_right_label3.txt','w')
	label_file=open(r'label_3_swipe_right.txt','w')
	...
	print 'the size is ',len(label_array),' and of data ',len(final_feature_array[0]),' and dimensions are ',len(final_feature_array)
