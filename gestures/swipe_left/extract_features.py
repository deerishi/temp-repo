...
def extract_features():
	...
	line=f.readline().split('\n')[0]
	fz=open(line,'r')
	vector_file=open(r'train_swipe_left_10_dim_features','w')
	#label_file=open(r'label_minus_1_swipe_left.txt','w')
	...
	print ' the final feature vector array is ',final_feature_array,' and length of data ',len(final_feature_array[0])
